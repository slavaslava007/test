import {CityType} from "../2/02_02";
import {addMoneyToBudget, createmessage, repairHouse, toFireStaff, toHireStaff} from "./3";
...
test.skip('Greting message shold be correct for city', () => {
    expect(createmessage(city)).toBe("Hello New York citizend. I love all 1000000 person")
